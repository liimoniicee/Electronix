...
//checar la validacion(no funciona el else:v)
 ...
 VALUES ('$equipo', '$marca', '$modelo', '$serie','$accesorio', '$falla', '$comentario', '$servicio', 'En ruta','Traslado', '$id');";
 $res = $conn->query($sql);
...
if($resu->num_rows > 0){
 ...
 while($row = $resu->fetch_assoc()) {
  ...
  VALUES ('En ruta', '$comentario', 'En ruta', 'Taller', '$idequipo', '$id', '$var_clave');";
