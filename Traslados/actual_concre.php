...
$query2 = "UPDATE ventas_tv SET  id_personal = '$var_clave', ubicacion = 'Carro $carro en ruta a $des'
WHERE
...
$query3 = "UPDATE reparar_tv SET  id_personal = '$var_clave', ubicacion = 'Carro $carro en ruta a $des'
WHERE
id_equipo='$id_equipo'";
