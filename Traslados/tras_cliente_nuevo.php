...
// Redirect the user
window.location.href = "Traslados.php";
...
var cel = <?php echo $cel ?>
  ...
  html:
  '<div class="card-body"> <form target="_blank" action="tras_pdf-orden.php" method="post" name="data" content="text/html; charset=utf-8" >'+
